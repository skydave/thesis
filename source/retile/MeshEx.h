...
/*
extern std::vector< std::pair<math::Vec3f, math::Vec3f> >   vectors;
extern std::vector< std::pair<math::Vec2f, math::Vec2f> > vectors2d;
extern std::vector<std::pair<math::Vec3f, math::Color> >     points;
extern std::vector<std::pair<math::Vec2f, math::Color> >   points2d;
